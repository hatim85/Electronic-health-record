...
async function main() {
    try {
        ...
        // call chaincode onboardPatient using Hospital01 identity so ledger has patient metadata
        ...
        const res = await contract.submitTransaction('registerPatient', JSON.stringify(args));
        console.log('onboardPatient tx result:', res.toString());
