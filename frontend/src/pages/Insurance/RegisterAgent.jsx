...
export default function RegisterAgent() {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!form.agentId) newErrors.agentId = "Agent ID is required";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ agentId: "", insuranceCompany: "", name: "", city: "" });
      setErrors({});
    } catch (err) {
      setMessage(`❌ ${err.error || "Failed to register agent"}`);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 sm:p-6">
      <div className="bg-white shadow-2xl rounded-2xl w-full max-w-lg p-8 sm:p-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Register Insurance Agent</h1>
