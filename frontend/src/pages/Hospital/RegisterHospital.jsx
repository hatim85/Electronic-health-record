...
const RegisterHospital = () => {
  ...
  const validateForm = () => {
    ...
    if (!form.name) newErrors.name = "Hospital Name is required";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ type: "error", text: err.error || "Hospital registration failed!" });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 sm:p-6">
      <div className="bg-white shadow-2xl rounded-2xl w-full max-w-lg p-8 sm:p-10">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Register Hospital</h1>
          <p className="text-sm text-gray-500 mt-2 text-center">
            Add a new hospital by filling out the details below
          </p>
        </div>
