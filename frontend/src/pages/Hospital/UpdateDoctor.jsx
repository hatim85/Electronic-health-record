...
const UpdateDoctor = () => {
  ...
  const validateForm = () => {
    ...
    if (!form.name) newErrors.name = "Doctor Name is required";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ type: "success", text: "👨‍⚕️ Doctor updated successfully!" });
      setForm({
        doctorId: "",
        hospitalId: "",
        name: "",
      ...
      setErrors({});
      setTimeout(() => navigate("/hospital/dashboard"), 2000); // Navigate after 2 seconds
    } catch (err) {
      setMessage({ type: "error", text: err.error || "Doctor update failed!" });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 sm:p-6">
      <div className="bg-white shadow-2xl rounded-2xl w-full max-w-lg p-8 sm:p-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Update Doctor</h1>
