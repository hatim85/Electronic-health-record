...
async function storeResearchResult(ctx, args) {
    ...
    if (role !== 'researcher')
        throw new Error('Only researchers can store research results');
    if (!args.datasetType || !args.resultSummary)
        throw new Error('datasetType and resultSummary required');
